...
export const NEWS = [
...

  {
    ...
    para2: `She accompanied the image with a positive message, encouraging her followers to start their week on a high note​`,
...
export const GALLERY = [
  ...
  { key: 'img15', img: '/photoshoots/kylienews1/img1.jpg', label: 'Kylie Jenner' },
  { key: 'img16', img: '/photoshoots/kylienews1/img2.jpg', label: 'Kylie Jenner' },
  { key: 'img17', img: '/photoshoots/kylienews1/img3.jpg', label: 'Kylie Jenner' },
  { key: 'img18', img: '/photoshoots/kylienews1/img4.jpg', label: 'Kylie Jenner' },
  { key: 'img18', img: '/photoshoots/kylienews1/img5.jpg', label: 'Kylie Jenner' },
...
export const BIOGRAPHY = [
...

  {
    ...
    career2: 'Her eponymous debut album, "Dua Lipa," was released in 2017 and included hits like "IDGAF" and the global smash "New Rules." The latter became her first UK number-one single. Lipa won the Brit Award for British Female Solo Artist and British Breakthrough Act in 2018.',

    career3: `In 2020, she released her critically acclaimed second studio album, "Future Nostalgia," which included hits such as "Don't Start Now," "Physical," "Break My Heart," and "Levitating." The album won the Grammy Award for Best Pop Vocal Album, and "Don't Start Now" received Grammy nominations for Record of the Year, Song of the Year, and Best Pop Solo Performance.`,

    pLife: 'Lipa has been in a relationship with Anwar Hadid, a model and younger brother of models Gigi and Bella Hadid, since 2019. She is known for her strong sense of style and often makes headlines for her fashion choices.',
...
export const PHOTOSHOOT = [
...

  {
    ...
    source: 'instagram',
    mainImg: '/photoshoots/erifilips1/main-img.jpg',
    img1: [
