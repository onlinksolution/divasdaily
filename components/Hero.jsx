  ...
  return (
    <section className="z-20">
      <div className="w-full h-full flex flex-col justify-center items-center absolute z-30 gap-6">
        ...
        <Link href="/biography" className="bg-btn py-4 px-6 text-xl rounded-full inline-flex items-center gap-3 hover:bg-bodyColor2 font-navFont hover:text-white duration-300">Expore Now <RiArrowRightLine /></Link>
      </div>
